...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.openModal = (type) => {
    ...
    if(type === "simulation") gameList.innerHTML = "<p>시뮬레이션 게임 준비 중...</p>";
    else if(type === "test") gameList.innerHTML = "<p>테스트 게임 준비 중...</p>";
    else if(type === "game") gameList.innerHTML = "<p>게임 준비 중...</p>";
